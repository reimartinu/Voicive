package com.martinreinmann.audiomidi;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MainApp.CalibrationActivity, MainApp", CalibrationActivity.class, __md_methods);
	}
	...
	public CalibrationActivity ()
	{
		...
		if (getClass () == CalibrationActivity.class)
			mono.android.TypeManager.Activate ("MainApp.CalibrationActivity, MainApp", "", this, new java.lang.Object[] {  });
	}
